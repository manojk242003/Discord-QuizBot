...
const QuizCreatorForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Validation: Check if all questions have a correct option selected
    const allQuestionsValid = questions.every((q) =>
      q.options.some((opt) => opt.isCorrect)
    );

    if (!allQuestionsValid) {
      toast.error('Please select a correct option for every question.');
    ...
    axios
      .post(
        "https://discord-quizbot-1.onrender.com/api/v1/createquiz",
        {
          title: quizTitle,
